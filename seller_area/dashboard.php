                ...
                <div class="row"><!-- panel-heading row begin -->
                    ...
                    <div class="col-xs-9 text-right"><!-- col-xs-9 text-right begin -->
                        <div class="huge"> <?php
                            ...
                            $get_orders = "select * from products where s_email='$seller_email'";
                    ...
                    <div class="col-xs-9 text-right"><!-- col-xs-9 text-right begin -->
                        <div class="huge"> 
                          <?php 
                                ...
                                $get_orders = "select * from pending_orders where s_email='$seller_email'";
                    ...
                    <table class="table table-hover table-striped table-bordered"><!-- table table-hover table-striped table-bordered begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                $get_order = "select * from pending_orders where s_email='$seller_email' order by 1 DESC LIMIT 0,5";
        ...
        <div class="panel"><!-- panel begin -->
            <div class="panel-body"><!-- panel-body begin -->
                <div class="mb-md thumb-info"><!-- mb-md thumb-info begin -->
                    ...
                    <img src="seller_images/<?php echo $seller_image; ?>" alt="<?php echo $seller_image; ?>" class="rounded img-responsive">
                    
                    <div class="thumb-info-title"><!-- thumb-info-title begin -->
                       
                        <span class="thumb-info-inner"> <?php echo $seller_name; ?> </span>
                ...
                <div class="mb-md"><!-- mb-md begin -->
                    <div class="widget-content-expanded"><!-- widget-content-expanded begin -->
                        <i class="fa fa-user"></i> <span> Email: </span> <?php echo $seller_email; ?> <br/>
                        <i class="fa fa-flag"></i> <span> Country: </span> <?php echo $seller_country; ?> <br/>
                        <i class="fa fa-envelope"></i> <span> Contact: </span> <?php echo $seller_contact; ?> <br/>
