       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-6"><!-- col-md-6 Begin -->
               ...
               <ul class="menu"><!-- cmenu Begin -->
                  ...
                  <li>
                       <a href="../seller_area/login.php">Seller Area</a>
                   </li>
           ...
           <div class="navbar-collapse collapse" id="navigation"><!-- navbar-collapse collapse Begin -->
               ...
               <div class="padding-nav"><!-- padding-nav Begin -->
                   ...
                   <ul class="nav navbar-nav left"><!-- nav navbar-nav left Begin -->
                       ...
                       <li class="<?php if($active=='ifarm') echo"active"; ?>">
                           <a href="ifarm.php?page=1">I-Farm</a>
                       </li>
      ...
      <div class="same-height-row">
        ...
        <div class="col-sm-12 ">
          ...
          if(isset($_GET["SearchButton"])){
            ...
            $stmt->execute();
          }// Query When Pagination is Active i.e ifarm.php?page=1
          ...
          <nav>
            <ul class="pagination pagination-lg">
              ...
              <?php if( isset($Page) ) {
                if ( $Page>1 ) {?>
             <li class="page-item">
                 <a href="ifarm.php?page=<?php  echo $Page-1; ?>" class="page-link">&laquo;</a>
               </li>
             <?php } }?>
            <?php
            global $ConnectingDB;
            ...
            for ($i=1; $i <=$PostPagination ; $i++) {
              ...
              <li class="page-item active">
                <a href="ifarm.php?page=<?php  echo $i; ?>" class="page-link"><?php  echo $i; ?></a>
              </li>
              <?php
            }else {
              ?>  <li class="page-item">
         ...
         <li class="page-item">
             <a href="ifarm.php?page=<?php  echo $Page+1; ?>" class="page-link">&raquo;</a>
           </li>
         <?php } }?>
            </ul>
          </nav>
